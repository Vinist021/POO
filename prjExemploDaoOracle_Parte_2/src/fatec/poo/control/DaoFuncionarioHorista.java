...
public class DaoFuncionarioHorista {
    ...
    public DaoFuncionarioHorista(Connection conn) {
     ...
     public  FuncionarioHorista consultar (int registro) {
        ...
        try {
            ps = conn.prepareStatement("SELECT * from tbFuncHorista " +
    ...
    public void inserir(FuncionarioHorista fh) {
        PreparedStatement ps = null;
        try {
            ps = conn.prepareStatement("INSERT INTO tbFuncHorista(Registro_FuncHor," +
    ...
    public void alterar(FuncionarioHorista fh) {
        PreparedStatement ps = null;
        try {
            ps = conn.prepareStatement("UPDATE tbFuncHorista set Nome_FuncHor = ?," +
    ...
    public void excluir(FuncionarioHorista fh) {
        PreparedStatement ps = null;
        try {
            ps = conn.prepareStatement("DELETE FROM tbFuncHorista where Registro_FuncHor = ?");
